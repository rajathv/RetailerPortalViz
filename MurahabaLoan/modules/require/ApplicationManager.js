/**
  ...
  */
 define(['ServiceResponseHandler'], function(ServiceResponseHandler) {
  /**
...
ApplicationManager.prototype.getApprovalsReqManager = function(){
 return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('ApprovalsReqManager').businessController;
};
...
ApplicationManager.prototype.getACHManager = function(){
 return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('ACHManager').businessController;
};
...
ApplicationManager.prototype.getBulkManager = function(){
 return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('BulkPayments').businessController;
};   
...
ApplicationManager.prototype.getExternalAccountsManager = function() {
	return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('ExternalAccountsManager').businessController;
}; 
...
return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('CampaignManagementManager').businessController;
};   
...
ApplicationManager.prototype.getTermsAndConditionManager = function() {
  return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('TermsAndConditionsManager').businessController;
};
...
return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('MFAManager').businessController;
}; 
...
return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('BusinessUserManager').businessController;
};
...
ApplicationManager.prototype.getLoansManager = function() {
    return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('LoansManager').businessController;
};
 
/**
* returns savings pot Manager object 
* @returns {object} value gives savingsPotManager object 
*/  
ApplicationManager.prototype.getSavingsPotManager = function() {
  return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('SavingsPotManager').businessController;
};
